...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/avririril?igsh=NjdkcjBhd3h2NjEw/", "_blank");
    }
    if (x == 2) {
        window.open("https://www.tiktok.com/@avririril?_t=8pJER0tz4Rp&_r=1//", "_blank");
    }
    if (x == 3) {
        window.open("https://open.spotify.com/user/ai0c9cdkw0b45e75b2v5yfw87?si=nBhdUV_OSSiGkupoxCNq-w", "_blank");
    }
    if (x == 4) {
        window.open("https://github.com/Vaneshaaskibidi?tab=repositories/", "_blank");
    }
}